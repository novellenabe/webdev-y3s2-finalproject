...
export default function page() {
  ...
  /* DATA FOR COOKING TIME AND PREPERATION TIME */
  ...
  const CT_hours = useRef(null),
    CT_minutes = useRef(null),
    PT_hours = useRef(null),
    PT_minutes = useRef(null),
    servings = useRef(null);

  const numChange = (trgt, t) => {
    let value,
      numericValue,
      nn = [...inputTypeNumber];
    // COOKING inputTypeNumber
    if (trgt === 0) {
      if (t === 0) {
        value = CT_hours.current.value;
      } else if (t === 1) {
        value = CT_minutes.current.value;
      }
      ...
      if (
        ...
        (parseInt(numericValue, 10) >= 0 &&
          parseInt(numericValue, 10) <= (t == 0 ? 12 : 60))
      ) {
        nn = [...inputTypeNumber];
        t === 0
          ? (nn[trgt].hours = numericValue)
          : (nn[trgt].minutes = numericValue);
        setInputTypeNumber(nn);
      }
    } // PREPERATION inputTypeNumber
    else if (trgt === 1) {
      if (t === 0) {
        value = PT_hours.current.value;
      } else if (t === 1) {
        value = PT_minutes.current.value;
      }
      ...
      // SERVINGS inputTypeNumber
      value = servings.current.value;
      numericValue = value.replace(/[^0-9]/g, "");
      if (
        numericValue === "" ||
        (parseInt(numericValue, 10) >= 0 && parseInt(numericValue, 10) <= 10)
      ) {
        nn = [...inputTypeNumber];
        nn[trgt].servings = numericValue;
        setInputTypeNumber(nn);
      }
    }
  };
  ...
  return (
    <main className="flex pt-15 justify-center flex-col w-full items-center">
      <form
        onSubmit={onSubmit}
        className="flex flex-col justify-center mt-15 w-full max-w-200 px-2 lg:px-0"
      >
        <div className="flex gap-10 flex-col lg:flex-row">
          ...
          <div className="hidden lg:inline-block lg:h-auto lg:min-h-[1em] lg:w-0.5 lg:self-stretch lg:bg-neutral-100 lg:dark:bg-white/10"></div>
          <div className="w-auto lg:w-100 bg-white rounded">
            <label
              htmlFor="recipe"
        ...
        <div className="flex mt-5 flex-col">
                  ...
                  >
                    {DIRN_editingIndex === index ? (
                      <input
                        ...
                        onKeyDown={(e) => handleKeyDown(index, e, "directions")}
                      ...
                      <>
                        ...
                        <button
                          onClick={() => handleDeleteItem(index, "directions")}
                ...
                {IGTS.map((item, index) => (
                  ...
                  >
                    {IGTS_editingIndex === index ? (
                      ...
                      <>
                        <span
                          onClick={() => handleTextClick(index, "ingredients")}
                          onMouseEnter={() =>
                        ...
                        <button
                          onClick={() => handleDeleteItem(index, "ingredients")}
                          className="ml-2 text-red-500 hover:text-red-700 focus:outline-none"
                        >
                          Delete
                        </button>
          ...
          <div className="flex flex-row gap-5 mt-5">
                ...
                <div className="flex flex-row gap-3">
                  <div className="flex flex-col w-22">
                    <input
                      ...
                      min="0"
                      max="59"
                      onChange={(e) => numChange(0, 0)}
                      value={inputTypeNumber[0].hours}
                      required
                    />
                    <label
                      htmlFor="cooking-time-hours"
                  ...
                  <div className="flex flex-col w-22">
                    <input
                      ref={CT_minutes}
                      onChange={(e) => numChange(0, 1)}
                      value={inputTypeNumber[0].minutes}
                      type="number"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row gap-3">
                  <div className="flex flex-col w-22">
                    <input
                      ref={PT_hours}
                      onChange={(e) => numChange(1, 0)}
                      value={inputTypeNumber[1].hours}
                      type="number"
                      id="preperation-time-hours"
                      name="preperation-time-hours"
                      aria-describedby="helper-text-explanation"
                      className="hide-spin-buttons text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      required
                    />
                    <label
                      htmlFor="preperation-time-hours"
                      className="text-center block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      Hours
                    </label>
                  ...
                  <div className="flex flex-col w-22">
                    <input
                      ref={PT_minutes}
                      onChange={(e) => numChange(1, 1)}
                      value={inputTypeNumber[1].minutes}
                      type="number"
                      id="preperation-time-mins"
                      name="preperation-time-mins"
                      aria-describedby="helper-text-explanation"
                      className="hide-spin-buttons text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      required
                    />
                    <label
                      htmlFor="preperation-time-mins"
                      className="text-center block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      Mins
                    </label>
            ...
            <div className="flex flex-row w-full justify-start lg:justify-center">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row gap-3">
                  <div className="flex flex-col w-22">
                    <input
                      ref={servings}
                      onChange={(e) => numChange(2, null)}
                      value={inputTypeNumber[2].servings}
                      type="number"
                      id="servings"
                      aria-describedby="helper-text-explanation"
                      className="hide-spin-buttons text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <label
                      htmlFor="servings"
                      className="text-center block mb-2 text-sm font-medium text-red-500 dark:text-white"
                    >
                      **Max 10**
                    </label>
                  </div>
        ...
        <div className="flex my-5 justify-center">
          <div className="flex gap-3">
            ...
            <button
              className="py-2 px-5 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded transition delay-50 rounded-3xl"
              type="submit"
            >
              Post recipe
            </button>

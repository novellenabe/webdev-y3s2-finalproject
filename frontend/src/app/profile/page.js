    ...
    <main className="flex pt-15 justify-center flex-col bg-white w-full">
      ...
      <section className="flex flex-col mx-2 items-center relative">
        <div className="flex flex-col items-center md:items-start md:flex-row gap-3 w-full bg-white px-6 min-[1265px]:w-310">
          ...
          />
          <div className="flex h-10 md:h-30 w-30"></div>
          ...
          <div className="flex md:my-5">
            <button className="bg-slate-200 rounded px-3 py-1 flex flex-row items-center gap-2">
              <svg
                height="20px"
                viewBox="0 0 24 24"
                fill="none"
      ...
      <section className="flex flex-col mt-5 md:mt-0 mx-2 items-center">
...
export default function page() {
  return (
    <main className="flex pt-15 justify-center flex-col bg-white w-full">
      ...
      <section className="flex flex-col mx-2 items-center relative">
        <div className="flex flex-row gap-3 w-full bg-white px-6 min-[1265px]:w-310">
          <img
            src="default-pfp.jpeg"
            alt="default-pfp"
            className="block rounded-full w-30 h-30 absolute -top-10 border-4 border-white"
          />
          <div className="flex w-30"></div>
          <div className="flex flex-col my-3 mr-auto">
            <span className="text-2xl font-bold">Albert Novell Enabe</span>
            <span className="text-slate-500">2 recipes</span>
          </div>
          <div className="flex my-5">
            <button className="bg-slate-200 rounded px-3 flex flex-row items-center gap-2">
              <svg
                height="20px"
                viewBox="0 0 24 24"
                fill="none"
      ...
      <section className="flex flex-col mx-2 items-center">
        <div className="flex flex-col w-full bg-white px-6 min-[1265px]:w-310">
          <hr className="border-slate-200" />
          <ul className="flex w-50 mt-1">
            <li className="w-1/2 border-b-4 border-blue-600">

...
export default function Header() {
  ...
  const user_LOGGEDIN_profile = () => {
    showPopup();
  };

  const user_LOGGEDOUT_profile = () => {
  ...
  return (
    <header className="bg-white fixed top-0 w-full z-10">
      <div className="flex justify-between px-4 h-15 items-center">
        ...
        <div className="flex gap-5 hidden md:block">
          {!isLoggedIn ? (
            ...
            <div className="relative">
              <button
                onClick={user_LOGGEDOUT_profile}
